				...
				<div class="collapse navbar-collapse" id="mainNavbarTheme">
					<ul class="navbar-nav mx-auto">
						...
						<li class="nav-item nav-item dropdown position-lg-static me-lg-3">
							...
							href="demo-shop-products-full-width.html" role="button"
							aria-haspopup="true" aria-expanded="false"> Exhibition </a>
						</li>
						<!--리뷰-->
			...
			<div class="container py-9 py-lg-11 position-relative">
					...
					<div class="col-md-12">
						...
						<div class="row mb-3 align-items-center" id="youna_flex_between">
							<div class="col-5 col-md-3 mb-4 mb-md-0">
								<h2 class="fc-toolbar-title">March 2022</h2>
							</div>
							<div class="col-5 col-md-1 mb-4 mb-md-0">
								<div class="btn-group">
									<button class="fc-prev-button btn btn-primary" type="button">❮</button>
									<button class="fc-next-button btn btn-primary" type="button">❯</button>
								</div>
							</div>
						</div>
					</div>
				...
				<div class="row mb-5">
					<div class="col-md-6 col-xl-4 mb-4">
						<!--:card-hover-expand-->
						<div
							class="card hover-shadow overflow-hidden hover-lift card-product border-0">
							<div
							...
							<div class="card-product-body px-4 pb-4 text-center">
								<a href="#!" class="h5 text-dark d-block position-relative mb-2">Product
									Title</a>
								<div class="card-product-body-ovelray">
									<span class="card-product-price"> <span>2022.03.31
											~ 2022.06.20</span>
					...
					<div class="col-md-6 col-xl-4 mb-4">
						...
						<div
							...
							<div
								class="card-product-header px-5 p-4 d-block overflow-hidden position-relative">
								<a href="#!"> <img src="/resources/img/shop/products/09.jpg"
									class="img-fluid" alt="Product">
								</a>
					...
					<div class="col-md-6 col-xl-4 mb-4">
						...
						<div
							...
							<div
								class="card-product-header px-5 p-4 d-block overflow-hidden position-relative">
								<a href="#!"> <img src="/resources/img/shop/products/10.jpg"
									class="img-fluid" alt="Product">
								</a>
							</div>
							<div class="card-product-body px-4 pb-4 text-center">
			...
			<div class="row align-items-center">
				<div class="col-md-8 order-md-last mb-3 mb-md-0">
					<div class="d-flex flex-wrap justify-content-md-end me-n4">
						...
						<a href="demo-shop-products-full-width.html"
