...
<body>
 ...
 <!--Header Start-->
        ...
        <div class="row align-items-center justify-content-center">
          <div class=" col-xl-4 col-lg-5 col-md-6 col-sm-8 z-index-2">
            ...
            <div class="position-relative">
              <div>
                <form action="/customer/customerLogin.do" class="needs-validation" novalidate>
                  <div class="input-icon-group mb-3">
                    ...
                    <input type="text" name="customer_id" class="form-control" required autofocus placeholder="Username"> 
                  </div>
                  <div class="input-icon-group mb-3">
                    <span class="input-icon">
                    ...
                    <!-- 비밀번호 input -->
                    <input type="password" name="customer_password" class="form-control" required placeholder="Password">
                  </div>
  ...
  <footer id="footer" class="overflow-hidden position-relative bg-dark text-white">
    <!--Divider-->
    <svg class="position-absolute start-0 bottom-0 text-gray-800 h-40" preserveAspectRatio="none" width="100%"
      height="250" viewBox="0 0 1200 250" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="container pt-9 pt-lg-11 pb-7 position-relative z-index-1">
      <div class="row mb-7">
        <div class="col-md-4 mb-5 mb-md-0 text-md-center order-md-2">
          <a href="index.html"><img src="/resources/img/logo/logo-white.svg" class="width-10x d-block h-auto mx-md-auto"
              alt=""></a>
        </div>
      ...
      <div class="row align-items-center">
        <div class="col-md-8 order-md-last mb-3 mb-md-0">
          <div class="d-flex flex-wrap justify-content-md-end me-n4">
            <a href="demo-shop.html" class="small text-muted me-4 link-hover-underline my-2 block">Home</a>
            <a href="#!" class="small text-muted me-4 link-hover-underline my-2 block">Exhibition</a>
            <a href="#!" class="small text-muted me-4 link-hover-underline my-2 block">Review</a>
            <a href="CustomerChangeInfo.do" class="small text-muted me-4 link-hover-underline my-2 block">Setting</a>
          </div>
        </div>
  ...
  <a href="#" class="toTop">
    <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 13 9' class="align-middle flip-y" width="13" height="9">
