                    ...
                    <div
                        ...
                        <div class="row align-items-end position-relative">
                            <div class="col-lg-6 col-xl-7">
                                <h5 class="text-muted mb-4">Let's start building</h5>
                                <h1 class="mb-5 mb-md-0 display-6">Stunning websites ease</h1>
                            </div>
                            <div class="col-lg-6 col-xl-5 text-lg-end">
                                <a href="#!" class="btn btn-outline-white rounded-pill me-2 mb-2 mb-lg-0">Contact sales</a>
                                <a href="#!" class="btn btn-white rounded-pill">Purchase Now</a>
                            </div>
                        </div>
                    </div>
                </div>
